...
<?php $rss = ItemTable::getInstance()->doFetchArray('Item', array('type, route, folder, image, title, year'), array('limit'=>10, 'isWatchOnline'=>'1'))?>
<ul class="">
...
<br clear="all">
<a href="<?php echo url_for('page/index?isWatchOnline=1')?>" class="more">Цааш</a>
<br clear="all">
