...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['options_addable']->renderLabel() ?></th>
        <td>
          <?php echo $form['options_addable']->renderError() ?>
          <?php echo $form['options_addable'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['multiple_choice']->renderLabel() ?></th>
        <td>
          <?php echo $form['multiple_choice']->renderError() ?>
          <?php echo $form['multiple_choice'] ?>
        </td>
      </tr>
      <tr>
