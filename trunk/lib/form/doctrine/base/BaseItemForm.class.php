...
abstract class BaseItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'studios'        => new sfValidatorString(array('max_length' => 500)),
      ...
      'official_link1' => new sfValidatorString(array('max_length' => 500)),
      'official_link2' => new sfValidatorString(array('max_length' => 500)),
      ...
      'source'         => new sfValidatorString(array('max_length' => 500)),
