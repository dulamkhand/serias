...
abstract class BaseItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_watch_online'   => new sfWidgetFormInputCheckbox(),
      'is_torrent_download'=> new sfWidgetFormInputCheckbox(),
      'is_mongolian_language'=> new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'is_watch_online'   => new sfValidatorBoolean(),
      'is_torrent_download'=> new sfValidatorBoolean(),
      'is_mongolian_language'=> new sfValidatorBoolean(),
