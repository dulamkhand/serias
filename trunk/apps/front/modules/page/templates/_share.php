<a target="_blank" title="Share on Facebook" 
    ...
    class="left" style="background:#1061bb;display:block;height:28px;width:95px;padding:7px 0 2px 10px;border-radius:4px;margin:15px 0 0 0;" 
...
<a target="_blank" title="Share on Twitter" 
    onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" 
    class="left" style="background:#3ccaeb;display:block;height:28px;width:95px;padding:7px 0 2px 10px;border-radius:4px;margin:15px 0 0 8px;" 
...
<a target="_blank" title="Share on Youtube" 
    onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" 
    class="left" style="background:#FF212A;display:block;height:28px;width:95px;padding:7px 0 2px 10px;border-radius:4px;margin:15px 0 0 8px;" 
    href="https://twitter.com/share?url=<?php echo $url?>&amp;via=<?php echo sfConfig::get('app_webname')?>&amp;text=<?php echo $title?>">
